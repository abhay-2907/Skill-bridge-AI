...
export default function Login() {
  ...
  const inp = {
    ...
    boxCloging: 'border-box', fontFamily: 'inherit',
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', color: '#f9fafb', margin: '0 0 0.5rem', letterSpacing: '-0.02em' }}>Sign in to SkillBridge AI</h1>
          <p style={{ fontSize: '0.8rem', color: '#6b7280', margin: 0 }}>Understand your skills. Find your gaps. Prepare smarter.</p>
        </div>
        {error && (
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input id="login-email" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="candidate@example.com" style={inp} />
          </div>
          <div style={{ marginBottom: '1.75rem' }}>
            <label style={{ display: 'block', fontSize: '0.78rem', fontWeight: '600', color: '#d1d5db', marginBottom: '0.4rem' }}>Password</label>
            <div style={{ position: 'relative' }}>
              <input id="login-password" type={showPass ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" style={{ ...inp, paddingRight: '2.8rem' }} />
        ...
        <p style={{ textAlign: 'center', fontSize: '0.8rem', color: '#6b7280', marginTop: '1.5rem', marginBottom: 0 }}>
          ...
          <Link to="/register" style={{ color: '#60a5fa', textDecoration: 'none', fontWeight: '500' }}>Register here</Link>
        </p>
      </div>
    </div>
  );
